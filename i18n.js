...
(function (global) {
  ...
  var DICT = {
    ...
    'Won ama ödeme': 'Won but payment is',
    'tamamlanmadı': 'not complete',
    'ama stage Won değil': 'but stage is not Won',
    've deal Won — otomatik kapatıldı': 'and deal is Won — auto-closed',
    'Ödeme %100 ve deal Won': 'Payment 100% and deal Won',
