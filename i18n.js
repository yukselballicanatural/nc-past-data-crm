...
(function (global) {
  ...
  var DICT = {
    ...
    'İşaretlendi,': 'Flagged,',
    'Sonra Tahsil Edildi': 'Then Collected',
    'Yakalanan': 'Overpayment',
    'Fazla Ödeme': 'Detected',
    'Won olmuş ama ödemesi eksik deal. Sistemin işaret ettiği, kasaya girmesi gereken para.': 'deals marked Won but underpaid. Money the system flagged as due to the company.',
    'deal ödeme eksikliği nedeniyle işaretlendi, ardından tahsilatı tamamlandı': 'deals were flagged for missing payment and were subsequently paid in full',
    'Bu, deal’lerin bugünkü toplam tahsilatı — tamamı alarmdan sonra gelmiş olmayabilir. Kesin ayrım için ödeme defteri gerekiyor (aşağıda).': 'This is those deals’ total collected to date — not all of it necessarily arrived after the alarm. The payment ledger below is required for an exact split.',
    "deal'de ödenen tutar sözleşmeden fazla. Ya iade ya da hatalı kayıt — her iki durumda da para riski.": 'deals where the paid amount exceeds the contract. Either a refund is due or the record is wrong — a financial risk either way.',
    '90+ gün': '90+ days',
    ...
    'Sistemin yakaladığı ve kasaya giren para. Tüm rakamlar gerçek kayıtlardan — tahmin yok.': 'Money the system caught and money that reached the company. Every figure comes from real records — no estimates.',
    '💰 İşaretlemeden Sonra Gelen Tahsilat — kesin ölçüm': '💰 Collected After Flagging — exact measurement',
    ...
    'Hastanın geliş tarihinden bu yana geçen süre. Yaşlı para tahsil edilmesi en zor olan paradır — en üstteki dilim en acil olan.': "Time elapsed since the patient's arrival date. Older money is the hardest to collect — the top band is the most urgent.",
