...
(function (global) {
  ...
  var DICT = {
    ...
    // dilde de kullanılan tüm varyantlar burada.
    'Konsültasyon Tarihi': 'Consultation Date',
    'Tahmini Seyahat Tarihi': 'Estimated Travel Date',
    'Konsültasyon Tarihi Aralığı': 'Consultation Date Range',
    'Tahmini Seyahat Tarihi Aralığı': 'Estimated Travel Date Range',
    'Konsültasyon Tarihi başlangıç': 'Consultation Date start',
    'Konsültasyon Tarihi bitiş': 'Consultation Date end',
    'Tahmini Seyahat Tarihi başlangıç': 'Estimated Travel Date start',
    'Tahmini Seyahat Tarihi bitiş': 'Estimated Travel Date end',
    'Konsültasyon Tarihi — başlangıç': 'Consultation Date — start',
    'Konsültasyon Tarihi — bitiş': 'Consultation Date — end',
    'Tahmini Seyahat Tarihi — başlangıç': 'Estimated Travel Date — start',
    'Tahmini Seyahat Tarihi — bitiş': 'Estimated Travel Date — end',
    'Konsültasyon (baş.)': 'Consult. (from)',
    'Konsültasyon (bit.)': 'Consult. (to)',
    'Seyahat (baş.)': 'Travel (from)',
    'Seyahat (bit.)': 'Travel (to)',
    'Konsültasyon': 'Consultation',
    'Seyahat': 'Travel',
    'Konsültasyon/Seyahat tarihi verisi yok.': 'No Consultation/Travel date data.',
    ...
    'Süzgece uyan kişi yok.': 'No one matches the filter.',
    'İsim, takım, bölge...': 'Name, team, region...',
    '{n} kişi': '{n} people',
    '{n} / {t} kişi': '{n} / {t} people',
    ...
    'Alarmı kapatmak için not yazmak zorunludur.': 'A note is required to close this alarm.',
    'Alarmı kapatmak için en az bir görsel eklemek zorunludur.': 'At least one image is required to close this alarm.',
    'Gelemedi olarak kapatmak için not yazmak zorunludur.': 'A note is required to mark this as no-show.',
    'Gelemedi olarak kapatmak için en az bir görsel eklemek zorunludur.': 'At least one image is required to mark this as no-show.',
    'Neden gelmedi? (zorunlu)…': 'Why didn’t they come? (required)…',
    ...
    'Bu tarih salt okunur — yalnızca son 3 gün düzenlenebilir. Daha eski günlerin düzeltme yetkisi admin panelindedir.': 'This date is read-only — only the last 3 days are editable. Older days can only be corrected in the admin panel.',
    'Bu tarih düzenlenemez — yalnızca son 3 gün. Daha eski günler için düzeltme yetkisi admindedir.': 'This date cannot be edited — only the last 3 days. Older days are admin-only.',
    ...
    'Aksiyon dağılımı ({r})': 'Action breakdown ({r})',
    'Günlük aktivite — {r}': 'Daily activity — {r}',
    'son {d} gün': 'last {d} days',
    '(seçili aralık)': '(selected range)',
    'Veri son 90 günü kapsar': 'Data covers the last 90 days',
    'Özel aralık aktif — üstteki genel dönemi geçersiz kılıyor': 'Custom range active — overrides the period above',
    'Başlangıç tarihi bitişten sonra olamaz.': 'Start date cannot be after the end date.',
    ...
    '2026 yılında hiç lead gelmedi': 'no leads arrived in 2026',
    'işlem yapılan {n} / 2026 lead {t}': '{n} handled / {t} leads in 2026',
    'kayıt yok': 'no record',
    ...
    'ödeme hareketi kaydedildi': 'payment movements recorded',
    "bunlardan işaretlenmiş deal'lere ait olan": 'of these, belonging to flagged deals',
    'toplam tahsilat': 'total collected',
    "Kasaya giren deal'ler": 'Deals that brought money in',
    "Kasaya giren deal'leri gör →": 'See the deals that brought money in →',
    'Para Giriş Tarihi': 'Money-in Date',
    'Rakamın arkasındaki gerçek para hareketleri': 'The real payment movements behind the figure',
    'İşaretlendi': 'Flagged',
    'Ödeme tamamlandı': 'Payment completed',
    'Sistem Etkisi': 'System Impact',
    'Sistem Etkisi — Para': 'System Impact — Money',
    'Kapsam: 2026 · satış takımları': 'Scope: 2026 · sales teams',
    'medyan': 'median',
    'ölçüm başlangıcı': 'measurement started',
    'Alarm kanıtı yükleniyor…': 'Loading alarm evidence…',
    'Tahsil Edilmeyi': 'Awaiting',
    'Bekleyen Para': 'Collection',
    'Yakalanan': 'Overpayment',
    '90+ gün': '90+ days',
    '31–90 gün': '31–90 days',
    '8–30 gün': '8–30 days',
    '0–7 gün': '0–7 days',
    'Gelecek tarih': 'Future date',
    'Tarih yok': 'No date',
    'Eğilim için en az iki gün gerekli.': 'At least two days are needed for a trend.',
    'Ödeme defteri kurulu — ilk ödeme değişimi bekleniyor': 'Payment ledger installed — awaiting the first payment change',
    'Günlük tahsilat akışı': 'Daily collection flow',
    'Takım bazlı': 'By team',
    "En büyük kalemler — rakamın arkasındaki gerçek deal'ler": 'Largest items — the real deals behind the figure',
    'Gelen Tutar': 'Amount In',
    'Sözleşme': 'Contract',
    'Kesin € ölçümü henüz devrede değil': 'Exact € measurement is not active yet',
    '⏳ Bekleyen paranın yaşı': '⏳ Age of outstanding money',
    '🏷️ Takım bazlı bekleyen para': '🏷️ Outstanding money by team',
    'Hangi takımın üzerinde ne kadar tahsil edilmemiş para var.': 'How much uncollected money sits with each team.',
    '📋 En büyük bekleyen kalemler': '📋 Largest outstanding items',
    'Geliş Tarihi': 'Arrival Date',
    'Yaş': 'Age',
    'Eksik': 'Shortfall',
    'Sistem Etkisi — Tahsil Edilmeyi Bekleyen Para': 'System Impact — Money Awaiting Collection',
    "İşaretlediğimiz deal'lerden kasaya giren": 'Collected from the deals we flagged',
    'Sistem buldu, henüz tahsil edilmedi': 'Found by the system, not yet collected',
    'Tahsili tamamlanan deal': 'Deals collected in full',
    'İşaretten tahsile (medyan)': 'Flag to payment (median)',
    'Yakalanan fazla ödeme': 'Overpayment detected',
    'Sistem kaç gündür çalışıyor': 'Days the system has been running',
    'Bu sistem devreye girdiğinden bu yana kasaya giren para.': 'Money that reached the company since this system went live.',
    'Her rakam gerçek kayıttan geliyor — tahmin yok.': 'Every figure comes from a real record — no estimates.',
    'deal ödeme eksikliği yüzünden işaretlendi, sonra ödemesi tamamlandı.': 'deals were flagged for missing payment and were then paid in full.',
    'Bu tutarın tamamı işaretlemeden sonra gelmiş olmayabilir — kesin ayrım için aşağıdaki ödeme defteri gerekiyor.': 'Not all of this necessarily arrived after flagging — the payment ledger below is required for an exact split.',
    'deal Won olarak işaretlenmiş ama ödemesi eksik. Sistemin bulduğu, kasaya girmesi gereken para.': 'deals are marked Won but underpaid. Money the system found that is still owed.',
    'Ödeme defteri her tutar değişimini zaman damgasıyla yazıyor. Aşağıdaki rakam,': 'The payment ledger timestamps every amount change. The figure below is',
    'Hastanın geliş tarihinden bu yana geçen süre. Yaşlı para, tahsil edilmesi en zor olan para.': "Time since the patient's arrival date. Older money is the hardest to collect.",
    "Won olmuş ama ödemesi eksik deal'ler — en büyük tutardan başlayarak.": 'Deals marked Won but underpaid — largest amount first.',
  };
